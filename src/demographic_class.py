...
class QuizLikeDatasetProcessor_DemographicClass:
    ...
    def prompt_create_demographic_quiz_answer_only(self):
        front_prompt = f"You are a {self.race} {self.gender} in the {self.age_range} age group. Read the question and provide your answer (only the option letter). Do not provide any explanation.\nQuestions:\n"
    ...
    def prompt_create_demographic_quiz_estimation_only(self):
        front_prompt = f"You are a {self.race} {self.gender} in the {self.age_range} age group. Read the question, estimate how many questions you can answer correctly (choose a number from 0-10). Do not provide any explanation.\nQuestions:\n"
    ...
    def prompt_create_demographic_quiz_answer_estimation(self):
        front_prompt = f"A is a {self.race} {self.gender} in the {self.age_range} age group. Read the question, consider A’s information, and then guess A’s answer (provide only the option letter). Do not provide any explanation. Finally, estimate how many questions (0-10) you think A can answer correctly.\nQuestions:\n"
